 ...
 * Activated when thalyazin.broker=rabbitmq.
 */
@AutoConfiguration
@ConditionalOnClass(RabbitTemplate.class)
@ConditionalOnProperty(name = "thalyazin.broker", havingValue = "rabbitmq")
@EnableConfigurationProperties(ThalyazinProperties.class)
public class RabbitMQBrokerAutoConfiguration {

    @Bean
    @ConditionalOnMissingBean
    public ConnectionFactory rabbitConnectionFactory(ThalyazinProperties properties) {
        ThalyazinProperties.RabbitMQ rabbitProps = properties.getRabbitmq();
