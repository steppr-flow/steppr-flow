...
class RabbitMQQueueInitializerTest {
    ...
    private ThalyazinProperties properties;
    private RabbitMQQueueInitializer initializer;

    @BeforeEach
    void setUp() {
        properties = new ThalyazinProperties();
        properties.getRabbitmq().setExchange("thalyazin-exchange");
    ...
    class InitializationTests {
        ...
        void shouldCreateExchanges() {
            ...
            assertThat(exchanges.get(0).getName()).isEqualTo("thalyazin-exchange");
            assertThat(exchanges.get(0)).isInstanceOf(TopicExchange.class);
            assertThat(exchanges.get(1).getName()).isEqualTo("thalyazin-exchange.dlq");
        ...
        void shouldConfigureDlqOnMainQueue() {
            ...
            assertThat(mainQueue.getArguments())
                    .containsEntry("x-dead-letter-exchange", "thalyazin-exchange.dlq")
        ...
        void shouldCreateFallbackQueueWhenNoWorkflows() {
            ...
            assertThat(fallbackQueue.getName()).isEqualTo("thalyazin-no-workflows");
        }
