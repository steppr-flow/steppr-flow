 ...
 * Activated when thalyazin.broker=kafka (default).
 */
@AutoConfiguration
@ConditionalOnClass(KafkaTemplate.class)
@ConditionalOnProperty(name = "thalyazin.broker", havingValue = "kafka", matchIfMissing = true)
...
public class KafkaBrokerAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public KafkaAdmin kafkaAdmin(ThalyazinProperties properties) {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnProperty(name = "thalyazin.workflow.executor.enabled", havingValue = "true", matchIfMissing = true)
