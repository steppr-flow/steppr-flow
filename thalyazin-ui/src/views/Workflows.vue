      ...
      <div class="flex flex-wrap items-center gap-3">
        ...
        <div class="flex-1 min-w-[150px]">
          <input
            ...
            class="w-full px-3 py-1.5 text-xs border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
          />
        </div>
        ...
        <div class="min-w-[140px]">
          <select
            ...
            class="w-full px-3 py-1.5 text-xs border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 bg-white"
          >
