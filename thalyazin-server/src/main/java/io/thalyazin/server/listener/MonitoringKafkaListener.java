package io.thalyazin.server.listener;
...
/**
 * Kafka listener for the monitoring server.
 *
 ...
 * microservices using thalyazin-agent.
 *
...
public class MonitoringKafkaListener {
    ...
    @KafkaListener(
            ...
            groupId = "${thalyazin.server.consumer.group-id:thalyazin-monitoring}"
    )
