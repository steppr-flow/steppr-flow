...
public class MetricsSummary {
    ...
    public double getSuccessRate() {
        ...
        return workflowsStarted > 0 ? (double) workflowsCompleted / workflowsStarted * 100 : 0;
    }
    ...
    public double getFailureRate() {
        return workflowsStarted > 0 ? (double) workflowsFailed / workflowsStarted * 100 : 0;
    }
    ...
    public double getThroughputRate() {
        return workflowsStarted > 0 ? (double) (workflowsCompleted + workflowsFailed) / workflowsStarted * 100 : 0;
    }
}