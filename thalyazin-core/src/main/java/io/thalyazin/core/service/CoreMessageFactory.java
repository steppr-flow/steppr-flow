...
public class CoreMessageFactory {
     ...
     */
    public WorkflowMessage createRetryMessage(WorkflowMessage original, RetryInfo retryInfo) {
     ...
     */
    public WorkflowMessage createDlqMessage(WorkflowMessage original, ErrorInfo errorInfo) {
        return WorkflowMessage.builder()
                .executionId(original.getExecutionId())
                .correlationId(original.getCorrelationId())
                .topic(original.getTopic())
     ...
     */
    public ErrorInfo createErrorInfo(Throwable cause, StepDefinition step) {
