...
import io.thalyazin.core.model.*;
...
class StepExecutorTest {
    ...
    class FailureHandlingTests {
        ...
        private ThalyazinProperties.Retry retryConfig;
        private ThalyazinProperties.Dlq dlqConfig;

        @BeforeEach
        void setUpRetryProperties() {
            retryConfig = new ThalyazinProperties.Retry();
            ...
            dlqConfig = new ThalyazinProperties.Dlq();
    ...
    class BackoffCalculationTests {
        ...
        @BeforeEach
        void setUpRetryProperties() {
            ThalyazinProperties.Retry retryConfig = new ThalyazinProperties.Retry();
