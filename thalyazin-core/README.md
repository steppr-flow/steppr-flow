...
Spring Boot framework for orchestrating asynchronous multi-step workflows via Apache Kafka.
...
<dependency>
    ...
    <artifactId>thalyazin-core</artifactId>
...
Create a class annotated with `@Topic` implementing `Thalyazin`:
