...
import io.thalyazin.monitor.dto.CircuitBreakerConfig;
import io.thalyazin.monitor.dto.CircuitBreakerStatus;
...
public class CircuitBreakerController {
    ...
    public ResponseEntity<CircuitBreakerConfig> getConfig() {
        ThalyazinProperties.CircuitBreaker cb = properties.getCircuitBreaker();
    ...
    @Operation(summary = "Get circuit breaker by name", description = "Get the status of a specific circuit breaker")
    @ApiResponses(value = {
    ...
    public ResponseEntity<CircuitBreakerStatus> getCircuitBreaker(
            @Parameter(description = "Circuit breaker name (e.g., broker-kafka, broker-rabbitmq)") @PathVariable String name) {
    ...
    @Operation(summary = "Reset circuit breaker", description = "Reset a circuit breaker to CLOSED state, clearing all metrics")
    @ApiResponses(value = {
