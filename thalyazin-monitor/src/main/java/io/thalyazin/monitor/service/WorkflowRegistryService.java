...
public class WorkflowRegistryService {
    ...
    private void createWorkflow(
        ...
        log.info("Registered new workflow: {} from service {}", workflowInfo.getTopic(), serviceInstance.getServiceName());
    }
    ...
    private void updateWorkflow(
        ...
        if (existing.getStatus() == RegisteredWorkflow.Status.INACTIVE) {
            ...
            log.info("Workflow {} reactivated by instance {}", workflowInfo.getTopic(), serviceInstance.getInstanceId());
        }
     ...
     */
    @Scheduled(fixedRateString = "${thalyazin.monitor.registry.cleanup-interval:PT1M}")
