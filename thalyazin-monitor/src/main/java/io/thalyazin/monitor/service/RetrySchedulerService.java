...
@Slf4j
@ConditionalOnProperty(prefix = "thalyazin.monitor.retry-scheduler", name = "enabled", havingValue = "true", matchIfMissing = true)
public class RetrySchedulerService {
     ...
     */
    @Scheduled(fixedDelayString = "${thalyazin.monitor.retry-scheduler.check-interval:30000}")
