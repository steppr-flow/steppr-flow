...
public class WorkflowMonitorService {
     ...
     * @deprecated Use {@link PayloadManagementService#updatePayloadField(String, String, Object, String, String)} instead.
     */
    @Deprecated
    public WorkflowExecution updatePayloadField(String executionId, String fieldPath, Object newValue, String changedBy, String reason) {
        return payloadService.updatePayloadField(executionId, fieldPath, newValue, changedBy, reason);
    }
