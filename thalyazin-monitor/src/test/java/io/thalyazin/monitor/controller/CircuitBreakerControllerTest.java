...
class CircuitBreakerControllerTest {
    ...
    class GetConfig {
        ...
        void shouldReturnConfig() {
            ThalyazinProperties.CircuitBreaker cbConfig = new ThalyazinProperties.CircuitBreaker();
            ...
            ResponseEntity<io.thalyazin.monitor.dto.CircuitBreakerConfig> response = controller.getConfig();
