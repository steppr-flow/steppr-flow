...
import io.thalyazin.monitor.websocket.WorkflowBroadcaster;
import io.thalyazin.monitor.websocket.WorkflowWebSocketHandler.WorkflowUpdateDTO;
...
class WebSocketIntegrationTest {
    ...
    static void properties(DynamicPropertyRegistry registry) {
        ...
        registry.add("thalyazin.circuit-breaker.enabled", () -> false);
        // Enable WebSocket
        registry.add("thalyazin.monitor.web-socket.enabled", () -> true);
        registry.add("thalyazin.monitor.web-socket.endpoint", () -> "/ws/workflow");
        registry.add("thalyazin.monitor.web-socket.topic-prefix", () -> "/topic/workflow");
