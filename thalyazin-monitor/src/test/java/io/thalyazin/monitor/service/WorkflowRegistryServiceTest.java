...
import io.thalyazin.monitor.repository.RegisteredWorkflowRepository;
    ...
    class RegisterWorkflowsTests {
        ...
        void shouldCreateSeparateWorkflowsForSameTopicFromDifferentServices() {
            ...
            WorkflowRegistrationRequest kafkaRequest = WorkflowRegistrationRequest.builder()
                    .serviceName("thalyazin-kafka-sample")
            ...
            when(repository.findByTopicAndServiceName("order-workflow", "thalyazin-kafka-sample"))
            ...
            assertThat(savedWorkflow.getServiceName()).isEqualTo("thalyazin-kafka-sample");
            ...
            WorkflowRegistrationRequest rabbitRequest = WorkflowRegistrationRequest.builder()
                    .serviceName("thalyazin-rabbitmq-sample")
            ...
            when(repository.findByTopicAndServiceName("order-workflow", "thalyazin-rabbitmq-sample"))
                    .thenReturn(java.util.Optional.empty());
            ...
            assertThat(rabbitWorkflow.getServiceName()).isEqualTo("thalyazin-rabbitmq-sample");
        }
