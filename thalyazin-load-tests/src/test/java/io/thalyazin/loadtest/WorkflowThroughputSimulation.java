 ...
 * <p>
 * Run with: mvn gatling:test -pl thalyazin-load-tests -Pload-test -Dgatling.simulationClass=io.thalyazin.loadtest.WorkflowThroughputSimulation
 * <p>
 * Prerequisites:
 * - Thalyazin sample application running on localhost:8080 with OrderWorkflow
