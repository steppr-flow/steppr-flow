# Thalyazin Load Tests

Performance and load testing suite for Thalyazin workflows.

## Overview

This module contains load tests to validate Thalyazin performance under various conditions using Gatling.
